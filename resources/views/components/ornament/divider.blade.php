{{-- Gold rule with a central lozenge — the separator used throughout the printed menu. --}}
@props(['width' => 'w-full'])

<div class="flex items-center justify-center gap-2 {{ $width }}" aria-hidden="true">
    <span class="gold-line h-px flex-1"></span>

    <svg viewBox="0 0 34 14" class="h-3 w-[34px] shrink-0 text-gold-300" fill="none">
